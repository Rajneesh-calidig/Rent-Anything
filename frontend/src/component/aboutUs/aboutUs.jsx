  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center px-4 py-10">
      ...
      <div className="max-w-6xl w-full bg-white shadow-lg rounded-lg p-6 md:p-12">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-6 bg-gray-50 rounded-lg shadow">
            ...
            <p className="text-gray-600 mt-2">
              Our mission is to make renting easy, accessible, and affordable for everyone. Whether
              it's tools, vehicles, electronics, or travel gear, we connect people to the things
              they need without the burden of ownership.
            </p>
          </div>
          <div className="p-6 bg-gray-50 rounded-lg shadow">
            <h3 className="text-xl font-semibold text-gray-800">Our Vision</h3>
            <p className="text-gray-600 mt-2">
              We envision a future where sharing resources is the norm, reducing waste and creating
              a sustainable, connected community through rental solutions.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12">
          <h3 className="text-2xl font-semibold text-center text-gray-800">Why Choose Us?</h3>
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-white shadow-md rounded">
              <h4 className="text-lg font-semibold">Convenience</h4>
              <p className="text-gray-600 mt-2">Rent anything, anytime, anywhere with ease.</p>
            </div>
            <div className="p-6 bg-white shadow-md rounded">
              <h4 className="text-lg font-semibold">Affordable</h4>
              <p className="text-gray-600 mt-2">Save money by renting instead of buying.</p>
            </div>
            <div className="p-6 bg-white shadow-md rounded">
              <h4 className="text-lg font-semibold">Secure Transactions</h4>
              <p className="text-gray-600 mt-2">Trust and security are our top priorities.</p>
            </div>
          </div>
        </div>
