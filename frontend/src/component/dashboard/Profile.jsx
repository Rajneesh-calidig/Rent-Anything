            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-center justify-center w-full">
                    ...
                    <div className="relative">
                        <img src={aadhaarPreview} alt="Aadhaar Preview" className="w-32 h-32 object-cover rounded-lg mb-2" />
                        <Cross className="absolute -top-1 -right-6 rotate-45 text-red-500 cursor-pointer" onClick={() => setAadhaarPreview(null)} />
                    </div>
                    ):(
                ...
                <div className="flex items-center justify-center w-full">
                    {panPreview ? (
                    <div className="relative">
                        <img src={panPreview} alt="PAN Preview" className="w-32 h-32 object-cover rounded-lg mb-2" />
                        <Cross className="absolute -top-1 -right-6 rotate-45 text-red-500 cursor-pointer" onClick={() => setPanPreview(null)} />
                    </div>
                    ):(
                    <label className="flex flex-col w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                    <div className="flex flex-col items-center justify-center pt-7">
