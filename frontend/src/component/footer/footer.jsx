...
export const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10">
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 px-6 py-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600">
              Subscribe to get updates on new rentals and offers.
            </p>
            <div className="flex">
              <input
                type="email"
                placeholder="Your email"
                className="px-4 py-2 rounded-l-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent w-full"
              />
        ...
        <div className="px-6 py-6 border-t border-gray-200 md:flex md:items-center md:justify-between">
