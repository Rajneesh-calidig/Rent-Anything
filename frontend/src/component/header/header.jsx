...
//       {/* Mobile Menu - Version 1: Match Desktop Header Style */}
//       <div
//         className={`lg:hidden transition-all duration-300 overflow-hidden ${
//           isOpen ? "max-h-screen" : "max-h-0"
//         }`}
//       >
//         <div className="bg-white shadow-lg rounded-b-lg mx-4 mt-2 p-4">
//           {/* Mobile Search */}
//           <div className="mb-4">
//             <div className="relative">
//               <input
...
//           {/* Mobile Navigation - Horizontal Style */}
//           <nav className="flex flex-wrap gap-2 mb-4">
//             <Link
//               to="/"
//               className="px-4 py-2 text-gray-700 hover:text-indigo-600 font-medium rounded-lg transition-colors hover:bg-gray-50"
...
//               <Link
//                 to="/signin"
//                 className="w-full text-center py-2 text-gray-700 hover:text-indigo-600 font-medium border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
//                 onClick={() => setIsOpen(false)}
//               >
//                 Sign In
//               </Link>
//               <Link
//                 to="/signup"
//                 className="w-full text-center bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium py-2 px-6 rounded-lg transition-all"
//                 onClick={() => setIsOpen(false)}
//               >
//                 Sign Up
//               </Link>
