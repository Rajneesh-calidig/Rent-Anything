...
.then(data=>{
    ...
    return (
        <>
      <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-xl m-8">
    <a href="#">
        <img className="p-8 rounded-2xl h-70 mx-auto" src={item.images[0]} alt="product image"  />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
