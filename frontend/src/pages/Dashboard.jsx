...
//                     <span className="text-indigo-600 font-medium flex items-center cursor-pointer" onClick={() => setActiveSection("my-items")}>
...
//                               <button className="text-indigo-600 hover:text-indigo-900" onClick={() => navigate('/item/' + item._id)}>
//                                 <Eye size={16} />
//                               </button>
...
//     console.log("Saving edited item:", editItemId, editItemData)

//     // After saving, return to my-items section
//     setActiveSection("my-items")
//     setEditItemId(null)
//   }
...
//             <div className="bg-white rounded-xl shadow-sm p-6">
//               <h2 className="text-xl font-semibold text-gray-800 mb-6">Edit Item</h2>
