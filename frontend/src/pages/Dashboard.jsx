...
import {User,Home,Package,Heart,Settings,LogOut,Plus,Menu,X} from "lucide-react"
...
export default function Dashboard() {
  ...
  const handleRenderSection = () => {
    switch (activeSection){
      case "overview":
        return <Overview setActiveSection={setActiveSection} user={user} myItemsLength={myItems.length} setActiveSidebarItem={setActiveSidebarItem} />
      case "my-items":
        return <MyItems setEditItemData={setEditItemData} setEditItemId={setEditItemId} setNewImages={setNewImages} setImagesToDelete={setImagesToDelete} setShowEditModal={setShowEditModal}/>
      case "add-item":
        return <AddItem />
      case "profile":
        return <Profile user={user} previewImage={previewImage} setPreviewImage={setPreviewImage} />
      case "settings":
        return <UserSettings />
      case "my-orders":
        return <MyOrders />
    ...
    <div className="min-h-screen">
      ...
      <div className="flex">
          ...
          <div className="p-4 border-b">
            <div className="flex items-center">
              <div className="relative">
                <img
                  src={previewImage || `${import.meta.env.VITE_FILE_URL}${user.profileImage}` || "/placeholder.svg"}
                  alt="Profile"
        ...
        <main className="flex-1 p-4 md:p-6 ml-0 pt-20 md:pt-6 bg-gray-100 rounded-xl overflow-hidden">
          ...
          {showEditModal && (
            <EditMyItem setShowEditModal={setShowEditModal} editItemData={editItemData} setEditItemData={setEditItemData} newImages={newImages} setNewImages={setNewImages} setEditItemId={setEditItemId} setImagesToDelete={setImagesToDelete} imagesToDelete={imagesToDelete} />
          )}
        </main>
      </div>
    </div>
